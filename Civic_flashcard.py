...
flashcards = [
    ...
    {"question": "Who is one of your state’s U.S. Senators now?", "answer": "Ted Cruz <br/> John Cornyn"},
    {"question": "The House of Representatives has how many voting members?", "answer": "435"},
    {"question": "We elect a U.S. Representative for how many years?", "answer": "2 years"},
    {"question": "Name your U.S. Representative.", "answer": "Lloyd Doggett"},
    ...
    {"question": "How many justices are on the Supreme Court?", "answer": "9"},
    ...
    {"question": "What is the capital of your state?", "answer": "Austin."},
    ...
    {"question": "Name one American Indian tribe in the United States.", "answer": "Cherokee; Navajo; Sioux; Chippewa; Choctaw; Pueblo; Arawak; Shawnee; Mohegan; Huron; Oneida; Lakota; Apache; Iroquois; Creek; Blackfeet; Seminole; Cheyenne; Crow; Teton; Hopi; Inuit"},
...
# remove old aria‐label CSS
# button color (default lightblue, hover blue)
st.markdown(
    """
    <style>
        /* all Streamlit buttons: light blue bg, black text */
        div[data-testid="stButton"] > button {
            background-color: #add8e6 !important;
            color: black !important;
        }
        /* on hover: blue bg, white text */
...
# ensure two buttons remain side-by-side on mobile
st.markdown(
    """
    <style>
...
if st.session_state.current_index is not None:
    ...
    st.markdown(
        ...
        '>
            ...
            <br>
            {"<br><b>Answer:</b><br>" + card['answer'] if st.session_state.show_answer else ""}
        </div>
        """,
        unsafe_allow_html=True
    )
